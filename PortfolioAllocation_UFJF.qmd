...
format:
    revealjs:
        ...
        footer: "Carlos Trucíos (IMECC/UNICAMP)  |   Semana da Estatística UFJF 2024  |   Risk-Based Portfolio Allocation  |   [ctruciosm.github.io](https://ctruciosm.github.io/)"
...
<center>
![](imagens/artigos_1--4.png){width="80%"}
</center>
...
::: {.column width="50%"}
<center>
![](imagens/RBF.png){width="75%"}
</center>
:::

::: {.column width="50%"}
<center>
![](imagens/artigo_5.png){width="75%"}
</center>
:::
::::
...
<center>
[Na prática, $\Sigma$ não é conhecido, devendo ser estimado com os dados ($\hat{\Sigma}$).]{style="color:red;"}
</center>
...
- Isto faz com que os pesos estejam alocados em poucos ativos, exista pouca diversificação e o desempenhho fora da amostra seja pobre `r emo::ji("sad")`
...
- Fazer um agrupamento hierárquico. Raffinot 2018 sugere utilizar a ligação _ward_ mas qualquer outra ligação  poderia ser utilizada.
...
- Dentro de cada cluster, calcular os pesos (iniciais) segundo o método _Naive Risk Parity_.
